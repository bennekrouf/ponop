...
exports.upload = function(req, res) {	
	...
	if (extentionFile === 'zip')
	{
		 ...
		 zipEntries.forEach(function(zipEntry) {
			 ...
			 {			 	
			 	...
			 	if (extension === 'jpg' || extension === 'png' || extension === 'bmp' || extension === 'jpeg') //si c'est une image on sauvegarde sa taille initiale
			 	{
	...
	else
	{
		...
		var target_path = './app/uploads/'+ presentationId + '/' + fileName;
		...
		fs.rename(tmp_path, target_path, function(err) {
		    ...
		    fs.unlink(tmp_path, function() {
		        ...
		        var result = { 'fileName': fileName, 'url':target_path}
